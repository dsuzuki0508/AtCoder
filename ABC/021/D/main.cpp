...
unsigned long long int factorial(unsigned long long int n, unsigned long long int MOD){
...
int main(void){
  ...
  cin>>n>>k;
  n=n+k-1;
  ModInt<1000000007> m = factorial(n, 1000000007);
  m /= factorial(k, 1000000007);
  m/= factorial(n-k, 1000000007);
  cout<<m.val()<<endl;
