...
int f(int n){
  //  cout<<"n= "<<n<<endl;
  int index = lower_bound(E, E+N/2, n)-E;
  //  cout<<"index = "<<index<<endl;
  return A[index] - ( min(B[index], E[index]-n)  );
}
...
int main(void){
  ...
  for(int i = 0;i< N/2;i++){
    ...
    cin>>tmp1>>tmp2;
    E[i]=tmp2;
    if(i==0)A.push_back(tmp2-tmp1);
    else A.push_back(tmp2-tmp1 + A[i-1]);
    B.push_back(tmp2-tmp1);
  }
